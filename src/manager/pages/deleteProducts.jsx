    ...
    const confirmDeleteHandler = async () => {
      ...
      return(
          ...
          <div style={{textAlign:"center"}} className='row'>
              <div className='col-md-12'><h2 danger>Are you sure?</h2></div>
              <div className='col-md-6'><Button onClick={confirmDeleteHandler} danger>Delete</Button></div>
              <div className='col-md-6'><Button  to={`/all-products`} danger>Cancel</Button></div>
          </div>
        </React.Fragment>
      );
}
