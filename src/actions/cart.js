...
export const loadCart = () => async (dispatch) => {
    try {
        ...
        const res = await axios.post('http://localhost:9000/api/cart/load', body, config);
...
export const loadCartCheckout = () => async (dispatch) => {
    try {
        ...
        const res = await axios.post('http://localhost:9000/api/cart/loadcheckout', body, config);
...
export const clearItemFromCart = (item) => async (dispatch) => {
    try {
        ...
        //axios part
        await axios.post('http://localhost:9000/api/cart/removeitem', newItem, config);
    } catch (err) {}
};
...
export const reduceQty = (item) => async (dispatch) => {
    try {
        ...
        await axios.post('http://localhost:9000/api/cart/updateqty', newItem, config);
    } catch (err) {}
};
